      ...
      "Properties": {
        ...
        "AssumeRolePolicyDocument": {
          "Ver"
                        ...
                        verification: {
                            position: { line: 421, character: 14 },
                            expectation: CompletionExpectationBuilder.create().expectItems([]).build(),
                        },
                    },
                    {
              ...
              "Statement": [
                {
                  ...
                  "Resource": {"Fn::Sub": "arn:aws:rds:\${AWS::R"}
                        ...
                        range: { start: { line: 421, character: 14 }, end: { line: 424, character: 7 } },
                        description:
                            'suggest pseudo-parameter inside Fn::Sub while authoring deeply nested resource property',
                        verification: {
                            position: { line: 448, character: 62 },
                            expectation: CompletionExpectationBuilder.create()
                                .expectContainsItems(['AWS::Region'])
                                .build(),
                        },
                    },
                    {
                        action: 'type',
                        content: `}`,
                        position: { line: 456, character: 2 },
                    },
                    {
                        action: 'type',
                        content: `egion}:\\$\{AWS::AccountId}:db:\\$\{Database}`,
                        position: { line: 448, character: 63 },
                        description: 'Complete Fn::Sub, add new resource',
                    },
                    {
                        action: 'type',
                        content: `,
        ...
        "Dimensions": [
          {"Fn::If": [
            ...
            },
            {
              "Name": "DBInstanceIdentifier",
              ""`,
                        range: { start: { line: 472, character: 14 }, end: { line: 472, character: 16 } },
                        description: 'Suggest Keys inside but filter out existing keys',
                        verification: {
                    ...
                    },
                    {
                        action: 'replace',
                        content: `"Value": {"Ref": "Database"}`,
                        range: { start: { line: 477, character: 14 }, end: { line: 477, character: 16 } },
                        description: 'Suggest Values inside but filter out existing values',
                    },
                    {
                        action: 'type',
                        position: { line: 480, character: 9 },
                        content: `,
        "AlarmActions": [
          {"Ref": "SNSTopic"}
        ],
    ...
    "Bucket": {
      ...
      "Properties": {
        ...
        "":`,
                    ...
                    {
                        action: 'replace',
                        range: { start: { line: 510, character: 8 }, end: { line: 510, character: 11 } },
                        content: `"VersioningConfiguration": {
          "Status": 
        }`,
                        description: 'Suggest enum values when at null location',
  ...
  "O"
    ...
    "VPCId": {
      ...
      "V"
                        ...
                        range: { start: { line: 517, character: 2 }, end: { line: 517, character: 5 } },
                        description: 'Suggest Output entity field Value',
                        verification: {
    ...
    "DatabaseEndpoint": {
      ...
      "Condition": "Is"`,
                        range: { start: { line: 520, character: 6 }, end: { line: 520, character: 9 } },
                        description: 'Condition usage within Outputs',
                        verification: {
                            position: { line: 538, character: 21 },
                            expectation: CompletionExpectationBuilder.create()
                                .expectContainsItems([
                                    'IsProduction',
                                    'IsNotProduction',
                    ...
                    },
                    {
                        action: 'type',
                        content: `ProductionOrStaging`,
                        position: { line: 538, character: 22 },
                    },
                    {
                        action: 'type',
                        content: `,
      ...
      "Value": {"Fn::Sub": [
        "Environment: \${Environment}\\nVPC: \${VpcId} (\${VpcCidr})\\nSubnets: \${SubnetList}\\nDatabase: \${DbEndpoint}:\${DbPort}\\nInstance Count: \${InstanceCount}\\nRegion AZs: \${AvailabilityZones}\\nMax Scaling: \${MaxScaling}",
        {
          "Environment": {"Ref": "E"}
                        ...
                        position: { line: 539, character: 5 },
                        description: 'Ref parameter inside Fn::Sub',
                        verification: {
                            position: { line: 545, character: 35 },
                            expectation: CompletionExpectationBuilder.create()
                                .expectContainsItems(['EnvironmentName'])
                                .build(),
                        },
          ...
          "VpcCidr": {"Fn::GetAtt": ["VPC", ""]}`,
                        range: { start: { line: 545, character: 35 }, end: { line: 545, character: 37 } },
                        description: 'GetAtt attribute returns all attributes',
                        verification: {
                            position: { line: 547, character: 45 },
                            expectation: CompletionExpectationBuilder.create()
                                .expectContainsItems(['DefaultNetworkAcl', 'CidrBlockAssociations'])
                                .build(),
                        },
          ...
          "DbPort": {"Fn::GetAtt": ["Database", "Endpoint."]}`,
                        range: { start: { line: 547, character: 45 }, end: { line: 547, character: 48 } },
                        description: 'Ref parameter inside Fn::Sub',
                        verification: {
                            position: { line: 549, character: 54 },
                            expectation: CompletionExpectationBuilder.create()
                                .expectContainsItems(['Endpoint.Address', 'Endpoint.Port'])
                                .build(),
                        },
                    ...
                    {
                        action: 'replace',
                        range: { start: { line: 550, character: 58 }, end: { line: 550, character: 61 } },
                        content: `Port"]},
          "InstanceCount": {"Ref": "InstanceCount"},
          ...
          {"Fn::Sub": [
            "\${First},\${Second},\${Third}",
            {
              "First": {"Fn::FindInMap": ["RegionMap", {"Ref": "AWS::Region"}, "A"]}
                    ...
                    {
                        action: 'delete',
                        range: { start: { line: 580, character: 81 }, end: { line: 580, character: 84 } },
                        description: 'Remove "]}',
                    },
              ...
              "Th`,
                        position: { line: 580, character: 81 },
                        description: 'suggest substitution variable in second arg of Fn::Sub based on first arg',
                        verification: {
                    ...
                    },
                    {
                        ...
                        position: { line: 582, character: 18 },
                        description: 'Complete the JSON template',
                        verification: {
                            position: { line: 576, character: 35 },
                            expectation: CompletionExpectationBuilder.create().expectItems([]).build(),
                        },
                    },
                ],
